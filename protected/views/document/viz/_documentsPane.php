            ...
            if (title !== null) {
                $.get("index.php?", {
                    ...
                    'query': $('input#query').val(),
                        ...
                        function (data) {
                            $(".result").html(data);
                            //console.log('saveSearch result ' + data.success);
                            //console.log(data);
                            if (data.success)
...
<div id="search-form" class="form-group" style="margin-bottom: 0px">
    <?php
    $this->renderPartial('viz/_searchForm', array(
        'model' => $model,
...
<?php
echo $this->renderPartial('viz/_docsGridView', ['docsGridDP' => $docsGridDP], true);
?>
