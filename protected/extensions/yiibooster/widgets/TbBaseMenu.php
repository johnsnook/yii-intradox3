...
//                $item['label'] = "<span class='" . $item['icon'] . "'></span>\r\n" . $item['label'];
        ...
        if (isset($item['badgeOptions'])) {
            $badge = $this->widget('booster.widgets.TbBadge', $item['badgeOptions'], true);
            $item['label'] = $item['label'] . '&nbsp;' . $badge;
        }
        ...
        /**
         * John Snook added the next two lines to allow ajaxlinks to be generated god dammit. 1/26/2015
         */
        if (isset($item['ajaxOptions'])) {
            return CHtml::ajaxLink($item['label'], $item['url'], $item['ajaxOptions'], $item['linkOptions']);
