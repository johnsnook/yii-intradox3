...
class TbExtendedGridView extends TbGridView {
    ...
    public function renderChart() {
        ...
        $options = CMap::mergeArray(
                $this->chartOptions['config'], array('series' => $seriesData, 'xAxis' => $xAxisData)
        );
    ...
    public function registerCustomClientScript() {
        ...
        if ($this->fixedHeader) {
            ...
            $fixedHeaderJs = "$('#{$this->id} table.items').stickyTableHeaders({fixedOffset:{$this->headerOffset}}); $('thead.tableFloatingHeaderOriginal th').addClass('panel');";
...
class TbPercentOfTypeGooglePieOperation extends TbPercentOfTypeOperation {
    ...
    public function registerClientScript() {
         ...
         */
        $this->column->grid->componentsAfterAjaxUpdate[__CLASS__] = 'var $el = $("#' . $this->getId() . '");var data = $el.data("data");var opts = $el.data("options");
