...
class CorrespondenceController extends Controller {
    ...
    public function actionUpdateForm($id) {
        ...
        /*
          ...
          $model->attributes = $_POST['Correspondence'];
          if ($model->save()) {
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('Correspondence');
    ...
    public function actionAdmin() {
        $model = new Correspondence('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Correspondence'])) {
            $model->attributes = $_GET['Correspondence'];
        }
    ...
    public function loadModel($id) {
        $model = Correspondence::model()->findByPk($id);
        if ($model === null) {
     ...
     * @param Correspondence $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'correspondence-form') {
